...
if all_races:
    ...
    master_table.to_csv(f'/Users/dimkostir/Desktop/Projects/F1/data/csv/master_table_24_25.csv')
    master_table.to_parquet(f'/Users/dimkostir/Desktop/Projects/F1/data/processed/master_tables/master_table_24_25.parquet')
else:
    print("\n\nNo races loaded!!!")

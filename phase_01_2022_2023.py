...
for year in years:
  ...
  for race in range(4, total_rounds + 1):
    try:
...
if all_races:
    ...
    master_table.to_csv(f'/Users/dimkostir/Desktop/Projects/f1-predictions/data/csv/master_23.csv')
    master_table.to_parquet(f'/Users/dimkostir/Desktop/Projects/f1-predictions/data/processed/master_tables/master_23.parquet')
else:
    print("\n\nNo races loaded!!!")
